...
public final class FileServer {
   ...
   * @param ncores The number of cores that are available to your multi-threaded file server. Using
   *     this argument is entirely optional. You are free to use this information to change how you
   *     create your threads, or ignore it.
